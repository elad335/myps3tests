...
int main() {
	...
	cellGcmMapEaIoAddress(ptr_cast(addr), 0x10000000 , 0x100000);
	...
	c.set_cmd(ctrl->get, 0x10000000 | RSX_METHOD_NEW_JUMP_CMD);
	c.set_cmd(0x10000000, 0x10000000 | RSX_METHOD_NEW_JUMP_CMD);
	sys_timer_usleep(40);

	c.push(0x40050); // NV406E_SET_REFERENCE cmd
